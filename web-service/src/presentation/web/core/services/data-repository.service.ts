...
export class DataRepositoryService {
    ...
    constructor(@Inject(HTTP_CLIENT) client: HTTPClient, @Inject(APP_CONFIG) config: AppConfig) {
        this.repository = new DataRepositoryUseCase(client, config.usersServiceURL)
    }
